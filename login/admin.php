...
<html>
    ...
    <body>
        <div class="row">
            ...
            <div class="col-sm-4">
                <h4 style="text-align: center"><a href="student.php">Student Login</a>&emsp;||&emsp;<a href="admin.php"  class="active">Admin Login</a></h4>
            </div>
        </div>
        <div class="container">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-8" >
                        ...
                        <form method="POST" action="" autocomplete="off">
                            <input placeholder="Enter admin ID" name="adminID" type="text" required="" autocomplete="off"><br/><br/>
                            <input placeholder="Enter Password" type="password" name="password" required="" autocomplete="new-password"><br/><br/>
                            <div class="bottom"><h6><a href="">Forgot account?</a></h6></div>
